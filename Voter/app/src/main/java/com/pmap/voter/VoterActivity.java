...
public class VoterActivity extends AppCompatActivity {
    ...
    @BindView(R.id.edt_votername)
    public
    EditText edt_votername;
    ...
    @BindView(R.id.btn_add_voter)
    Button btn_add_voter;
    ...
    private String el_id="";
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.voters);
            ButterKnife.bind(this);
            context = VoterActivity.this;


            txt_password.setVisibility(View.GONE);
            btn_add_voter.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (!P.isValidEditText(edt_votername, "VoterName")) return;
                   // if (!P.isValidEditText(edt_password, "Password")) return;
                    if (!P.isValidEditText(edt_taluk, "Taluk")) return;
                    if (!P.isValidEditText(edt_mobile, "voter_mobile_number")) return;
                    if (!P.isValidMobileNumber(edt_mobile, "voter_mobile_number")) return;

                    // if (!P.isValidEmail(edt_email.getText().toString().trim())) return;
                    if (!P.isValidEditText(edt_adhaar, "Adhaar")) return;
                   // sendSMS(edt_mobile.getText().toString(),txt_password.getText().toString()) ;
...
txt_password.setText(generate(5));
                    sendSMS(edt_mobile.getText().toString(),"Your OVUB Username: "+edt_mobile.getText().toString()+" Password: "+txt_password.getText().toString()) ;
  ...
  /*protected void sendSMS() {
      ...
      try {
          ...
          Toast.makeText(VoterActivity.this,
                  "SMS faild, please try again later.", Toast.LENGTH_SHORT).show();
      }
  }*/
    private void voterRegister() {
        Retrofit retrofit = Api.getRetrofitBuilder(this);
        WebServices webServices = retrofit.create(WebServices.class);

        //PREPARE INPUT/REQUEST PARAMETERS
        VoterRegisterInput voterRegisterInput = new VoterRegisterInput(
                edt_votername.getText().toString().trim(),
        ...
        P.hideSoftKeyboard(VoterActivity.this);


        //CALL NOW
        webServices.voterRegister(voterRegisterInput)
                .enqueue(new Callback<VoterRegisterOutput>() {
                    @Override
                    public void onResponse(Call<VoterRegisterOutput> call, Response<VoterRegisterOutput> response) {
                        ...
                        VoterRegisterOutput result = response.body();
                    ...
                    @Override
                    public void onFailure(Call<VoterRegisterOutput> call, Throwable t) {
...
private String generate(int lenght){
    ...
    private void initializeUI() {
        state_Spinner = (Spinner) findViewById(R.id.spn_state);
        district_Spinner = (Spinner) findViewById(R.id.spn_district);
